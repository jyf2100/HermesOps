...
const translations: Record<DesktopLocale, Record<TranslationKey, string>> = {
  en: {
    'tray.show': 'Show NewHermes Studio',
    'tray.hide': 'Hide NewHermes Studio',
    'tray.checkForUpdates': 'Check for Updates',
    'tray.openAtLogin': 'Open at Login',
    'tray.quit': 'Quit NewHermes Studio',
    'update.upToDateTitle': 'NewHermes Studio',
    'update.upToDateMessage': 'NewHermes Studio is up to date.',
    'update.checkingTitle': 'NewHermes Studio',
    ...
    'update.availableMessage': 'NewHermes Studio {version} is available.',
    'update.downloading': 'The update is downloading in the background.',
    'update.readyTitle': 'Update ready',
    'update.readyMessage': 'NewHermes Studio {version} is ready to install.',
    ...
    'update.failedMessage': 'Could not check for NewHermes Studio updates.',
    ...
    'desktop.downloadCloudflareDetail': 'Use the NewHermes Studio download proxy.',
  ...
  zh: {
    'tray.show': '显示 NewHermes Studio',
    'tray.hide': '隐藏 NewHermes Studio',
    'tray.checkForUpdates': '检查更新',
    'tray.openAtLogin': '开机启动',
    'tray.quit': '退出 NewHermes Studio',
    'update.upToDateTitle': 'NewHermes Studio',
    'update.upToDateMessage': 'NewHermes Studio 已是最新版本。',
    'update.checkingTitle': 'NewHermes Studio',
    'update.checkingMessage': '正在检查更新...',
    'update.currentVersion': '当前版本：{version}',
    'update.availableTitle': '发现新版本',
    'update.availableMessage': 'NewHermes Studio {version} 可用。',
    'update.downloading': '更新正在后台下载。',
    'update.readyTitle': '更新已就绪',
    'update.readyMessage': 'NewHermes Studio {version} 已准备好安装。',
    'update.readyDetail': '立即重启以应用更新，或下次退出时自动安装。',
    'update.restartNow': '立即重启',
    'update.download': '下载',
    'update.later': '稍后',
    'update.failedTitle': '检查更新失败',
    'update.failedMessage': '无法检查 NewHermes Studio 更新。',
    ...
    'desktop.downloadCloudflareDetail': '使用 NewHermes Studio 下载代理。',
  ...
  'zh-TW': {
    'tray.show': '顯示 NewHermes Studio',
    'tray.hide': '隱藏 NewHermes Studio',
    'tray.checkForUpdates': '檢查更新',
    'tray.openAtLogin': '開機啟動',
    'tray.quit': '結束 NewHermes Studio',
    'update.upToDateTitle': 'NewHermes Studio',
    'update.upToDateMessage': 'NewHermes Studio 已是最新版本。',
    'update.checkingTitle': 'NewHermes Studio',
    ...
    'update.readyMessage': 'NewHermes Studio {version} 已準備好安裝。',
    'update.readyDetail': '立即重新啟動以套用更新，或下次結束時自動安裝。',
    'update.restartNow': '立即重新啟動',
    'update.download': '下載',
    'update.later': '稍後',
    'update.failedTitle': '檢查更新失敗',
    'update.failedMessage': '無法檢查 NewHermes Studio 更新。',
    ...
    'desktop.downloadCloudflareDetail': '使用 NewHermes Studio 下載代理。',
  ...
  ja: {
    ...
    'desktop.downloadCloudflareDetail': 'NewHermes Studio のダウンロードプロキシを使用します。',
  ...
  ko: {
    'tray.show': 'NewHermes Studio 표시',
    'tray.hide': 'NewHermes Studio 숨기기',
    'tray.checkForUpdates': '업데이트 확인',
    'tray.openAtLogin': '로그인 시 열기',
    'tray.quit': 'NewHermes Studio 종료',
    'update.upToDateTitle': 'NewHermes Studio',
    'update.upToDateMessage': 'NewHermes Studio가 최신 버전입니다.',
    'update.checkingTitle': 'NewHermes Studio',
    'update.checkingMessage': '업데이트를 확인하는 중...',
    'update.currentVersion': '현재 버전: {version}',
    'update.availableTitle': '업데이트 사용 가능',
    'update.availableMessage': 'NewHermes Studio {version}을 사용할 수 있습니다.',
    'update.downloading': '업데이트를 백그라운드에서 다운로드하고 있습니다.',
    'update.readyTitle': '업데이트 준비 완료',
    'update.readyMessage': 'NewHermes Studio {version}을 설치할 준비가 되었습니다.',
    ...
    'update.failedMessage': 'NewHermes Studio 업데이트를 확인할 수 없습니다.',
    ...
    'desktop.downloadCloudflareDetail': 'NewHermes Studio 다운로드 프록시를 사용합니다.',
  ...
  fr: {
    'tray.show': 'Afficher NewHermes Studio',
    'tray.hide': 'Masquer NewHermes Studio',
    'tray.checkForUpdates': 'Rechercher les mises a jour',
    'tray.openAtLogin': 'Ouvrir a la connexion',
    'tray.quit': 'Quitter NewHermes Studio',
    'update.upToDateTitle': 'NewHermes Studio',
    'update.upToDateMessage': 'NewHermes Studio est a jour.',
    'update.checkingTitle': 'NewHermes Studio',
    ...
    'update.availableMessage': 'NewHermes Studio {version} est disponible.',
    'update.downloading': 'La mise a jour se telecharge en arriere-plan.',
    'update.readyTitle': 'Mise a jour prete',
    'update.readyMessage': 'NewHermes Studio {version} est pret a etre installe.',
    ...
    'update.failedMessage': 'Impossible de rechercher les mises a jour de NewHermes Studio.',
    ...
    'desktop.downloadCloudflareDetail': 'Utilise le proxy de telechargement NewHermes Studio.',
  ...
  es: {
    'tray.show': 'Mostrar NewHermes Studio',
    'tray.hide': 'Ocultar NewHermes Studio',
    'tray.checkForUpdates': 'Buscar actualizaciones',
    'tray.openAtLogin': 'Abrir al iniciar sesion',
    'tray.quit': 'Salir de NewHermes Studio',
    'update.upToDateTitle': 'NewHermes Studio',
    'update.upToDateMessage': 'NewHermes Studio esta actualizado.',
    'update.checkingTitle': 'NewHermes Studio',
    ...
    'update.availableMessage': 'NewHermes Studio {version} esta disponible.',
    'update.downloading': 'La actualizacion se esta descargando en segundo plano.',
    'update.readyTitle': 'Actualizacion lista',
    'update.readyMessage': 'NewHermes Studio {version} esta listo para instalarse.',
    ...
    'update.failedMessage': 'No se pudieron buscar actualizaciones de NewHermes Studio.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa el proxy de descarga de NewHermes Studio.',
  ...
  de: {
    'tray.show': 'NewHermes Studio anzeigen',
    'tray.hide': 'NewHermes Studio ausblenden',
    'tray.checkForUpdates': 'Nach Updates suchen',
    'tray.openAtLogin': 'Beim Anmelden offnen',
    'tray.quit': 'NewHermes Studio beenden',
    'update.upToDateTitle': 'NewHermes Studio',
    'update.upToDateMessage': 'NewHermes Studio ist auf dem neuesten Stand.',
    'update.checkingTitle': 'NewHermes Studio',
    ...
    'update.availableMessage': 'NewHermes Studio {version} ist verfugbar.',
    'update.downloading': 'Das Update wird im Hintergrund heruntergeladen.',
    'update.readyTitle': 'Update bereit',
    'update.readyMessage': 'NewHermes Studio {version} ist zur Installation bereit.',
    ...
    'update.failedMessage': 'Updates fur NewHermes Studio konnten nicht gepruft werden.',
    ...
    'desktop.downloadCloudflareDetail': 'Verwendet den NewHermes Studio Download-Proxy.',
  ...
  pt: {
    ...
    'tray.quit': 'Sair do NewHermes Studio',
    'update.upToDateTitle': 'NewHermes Studio',
    'update.upToDateMessage': 'NewHermes Studio esta atualizado.',
    'update.checkingTitle': 'NewHermes Studio',
    ...
    'update.availableMessage': 'NewHermes Studio {version} esta disponivel.',
    'update.downloading': 'A atualizacao esta sendo baixada em segundo plano.',
    'update.readyTitle': 'Atualizacao pronta',
    'update.readyMessage': 'NewHermes Studio {version} esta pronto para instalar.',
    ...
    'update.failedMessage': 'Nao foi possivel verificar atualizacoes do NewHermes Studio.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa o proxy de download do NewHermes Studio.',
